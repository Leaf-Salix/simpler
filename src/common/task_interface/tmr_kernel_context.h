...
static_assert(
    std::is_trivially_copyable_v<TmrKernelContextDescriptor> &&
    std::is_standard_layout_v<TmrKernelContextDescriptor>
);
...
static_assert(
    std::is_trivially_copyable_v<TmrContextRegistrationArgs> &&
    std::is_standard_layout_v<TmrContextRegistrationArgs>
);
...
static_assert(
    std::is_trivially_copyable_v<TmrCallableRegistrationArgs> &&
    std::is_standard_layout_v<TmrCallableRegistrationArgs>
);
