...
public:
     ...
     * on the arena path keys on it; claiming the mode is an init entry's
     * obligation, and no entry claims, so the mode stays unclaimed on every
     * context and those guards never fire.
     */
