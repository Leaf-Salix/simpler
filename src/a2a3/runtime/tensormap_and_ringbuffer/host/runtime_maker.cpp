...
// Kernel-mode prepare owns one immutable TMR arena image for the context. It
// reuses the exact reserve/build/upload path used by the program prebuilt
// arena, but never binds invocation arguments or changes the image at launch.
...
extern "C" const char *const *runtime_extra_aicpu_symbols(size_t *count) {
    static const char *const kExtra[] = {
        ...
        "simpler_aicpu_release_tmr_kernel_callable", "simpler_aicpu_prepare_tmr_context",
